...
# create a variable called revision to ask the user if they wish to revise
...
# create a counter if statement to reprint revision if the user doesn't want to shut down
elif shutdown == 'n':
    print(revision)
